...
export default function EmoFrogFlower( { animateFrogs }: EmoFrogFlowerProps ) {
    ...
    return (
        <div
            ...
            ref={frogsRef}
            style={{
                transform: animateFrogs ? `translateX(${centerXTranslate}px) translateY(24rem)` : "none"
            }}
            className={`w-48 relative h-1/6 transition-transform duration-2000`}
        >
            <h1 className={`absolute bottom-3 left-16 text-8xl font-bold uppercase text-white drop-shadow-lg font-alumni
